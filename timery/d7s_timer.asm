...
CZAS equ 79h	;tablica przechowuj¹ca wskazanie zegara
SS equ 78h
MM equ 77h
GG equ 76h
...
petla:
	...
	;TUTAJ jestem 1152 razy nasekundê
...
przelicz:
	...
	mov CZAS+0, B		;jednostki sekund na swoje miejsce w tablicy CZAS
	mov CZAS+1, A		;dziesi¹tki sekund na swoje miejsce w tablicy CZAS
